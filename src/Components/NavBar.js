  ...
  return (
   ...
   >
     ...
     <form onSubmit={handleSubmits}>
       <input className={styles.titleInp} placeholder="Name" onChange={(e)=>setTitlee(e.target.value)} value={titlee}/>
       <input className={styles.AlbumId} placeholder="AlbumId" type="number" onChange={(e)=>setUserIds(e.target.value)} value={userIds}/>
       <input className={styles.AlbumId} placeholder="Id" type="number" onChange={(e)=>setIds(e.target.value)} value={ids}/>
